...
$mobileNo = mysqli_real_escape_string($Consultant_conn,$_POST['mobileNo']);
...
$query = "SELECT * FROM login WHERE mobileNo = '$mobileNo' AND Password = '$Password'";
 if ($result = mysqli_query($Consultant_conn,$query)) {
    ...
    if ($rowcount==1) {
      ...
      $_SESSION['ConsultantCode']=$row['ConsultantCode'];
      // echo "success";
