      ...
      <img style="width: 200px;" src="../images/MyJiyasaLogo1.png">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a style="margin-right: 10px;background-color: #0054D1;color: white;" class="btn btn-primary" href="./course.php?CourseName=ConsultantTr&LectureNo=520625572">Training</a>
            </li>
